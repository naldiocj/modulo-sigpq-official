...
import CrudBaseRepositorio from "../../../repositories/crud-base-repostorio";
...
export default class Controller implements ModuleInterfaceController {
  ...
  public async registar({
    ...
    useLogger(request, auth, "registar", "tratamento de correspondencias");
  ...
  public async listarUm({
    ...
    useLogger(request, auth, "listar um", "tratamento de correspondencias");
  ...
  public async eliminar({
    ...
    useLogger(request, auth, "eliminar", "tratamento de correspondencias");

...
export default class Controller implements ModuleInterfaceController {
  ...
  public async listarTodos({
    ...
    Logger.info(getLogFormated(user, "listar todos", "gerar passes"), {
      user_id: user.id,
      ip: clientIp,
    });
  ...
  public async registar({
    ...
    Logger.info(getLogFormated(user, "registar", "gerar passes"), {
      user_id: user.id,
      ip: clientIp,
    });
  ...
  public async listarUm({
    ...
    Logger.info(getLogFormated(user, "listar um", "gerar passes"), {
      user_id: user.id,
      ip: clientIp,
    });

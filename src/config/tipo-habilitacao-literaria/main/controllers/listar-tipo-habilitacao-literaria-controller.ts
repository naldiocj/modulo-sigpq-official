...
import ListarTipoHabilitacaoLiterariaRepositorio from '../../repositories/listar-tipo-habilitacao-literaria-repositorio'
...
export default class RegistarTipoHabilitacaoLiterariaController {
  #repo
  constructor() {
    this.#repo = new ListarTipoHabilitacaoLiterariaRepositorio()
  }

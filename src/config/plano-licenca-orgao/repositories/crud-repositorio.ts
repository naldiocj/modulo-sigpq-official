...
export default class CrudRepository {
  ...
  #baseRepo
  constructor() {
    this.#baseRepo = new BaseModuloRepository('sigpq_plano_licenca_orgaos')
  }
  ...
  public async registar(input: IInput, trx = null): Promise<any> {
    ...
    try {
      ...
      console.log(e);
      return Error('Não foi possível criar um novo Plano Licença Orgão.');
    }
  }
  ...
  public async delete(id: any,auth: any, trx = null): Promise<any> {
    ...
    try {
      ...
      console.log(e);
      return Error('Não foi possível eliminar o Plano Licença Orgão.');
    }
  }

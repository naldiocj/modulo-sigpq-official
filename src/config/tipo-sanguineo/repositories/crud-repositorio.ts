...
const tipoSanguineoRepository = new BaseRepository<IInput>('sigpq_tipo_sanguineos');
...
export default class CrudRepository {
  ...
  public async listarTodos(options: any): Promise<any> {
    ...
    try {
      ...
      let query: DatabaseQueryBuilderContract = Database.from({ s: 'sigpq_tipo_sanguineos' })
        .select(
          's.id',
          's.nome',
          's.sigla',

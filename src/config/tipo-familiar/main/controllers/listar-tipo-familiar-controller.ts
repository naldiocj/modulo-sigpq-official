...
import ListarTipoFamiliarRepositorio from '../../repositories/listar-tipo-familiar-repositorio'

const { ok } = require('App/Helper/Http-helper');


export default class RegistarTipoFamiliarController {
  #repo
  constructor() {
    this.#repo = new ListarTipoFamiliarRepositorio()
  }

...
import ListarTipoMeioRepositorio from '../../repositories/listar-tipo-meio-repositorio'

const { ok } = require('App/Helper/Http-helper');


export default class RegistarTipoMeioController {
  #repo
  constructor() {
    this.#repo = new ListarTipoMeioRepositorio()
  }

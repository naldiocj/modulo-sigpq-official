    ...
    const dataNew = [
      {
        ...
        dia_selecionado: new Date('2025-01-01'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-02-04'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-03-04'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-03-08'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-03-23'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-03-18'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-04-04'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        descricao: 'Criado automaticamente pelo sistema.',
        observacoes: 'Celebra a paz e a reconciliação nacional.',
        dia_selecionado: new Date('2025-04-18'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-05-01'),
        created_at: new Date(),
        updated_at: new Date()
      },

      {
        ...
        dia_selecionado: new Date('2025-09-17'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-11-02'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-11-11'),
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        dia_selecionado: new Date('2025-12-25'),
        created_at: new Date(),
        updated_at: new Date()
      }
    ];
